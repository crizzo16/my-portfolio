    ...
    <div>
      <div className="flex f-around">
        <p className="content-message">
          Ever since I've access to a computer, I've loved spreadsheets. There's
          something so lovely about clean, well-formatted, and visually
          appealing data. Throughout all my various hobbies, spreadsheets are a
          commonality. Below, you'll see a spreadsheet where I track the
          releases of packs for the Sims 4, a spreadsheet where I try to predict
          the winner of Eurovision from Youtube rankings, a spreadsheet where I
          list all of the books I own, and more! Many of these spreadsheets I
          actively use and update with new information, so keep an eye out for
          change.
        </p>
        ...
        <div className="hide">
          <div className="container">
            ...
            <p>
              ...
              were already color-coded, making this a very colorful spreadsheet!
            </p>
          </div>
          <iframe
            id="frame-sims"
        ...
        <div className="hide">
          <div className="container">
            ...
            <p>
              ...
              ranking), I tried to predict who would win - or at least make the
              finals. While Sweden, the top choice, didn't win, it did place
              4th. A big surprise was Austria. While they were the only non-Big
              5 country to always make the finals in the Youtube rankings, their
              average performance didn't qualify they for the finals, showing
              that analysis of studio versions of songs can't fully predict what
              happens when everyone gets on the Eurovision stage.
            </p>
          </div>
          <iframe
            id="frame-esc22"
